...
final class Version20230427174044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE open_hour (id INT AUTO_INCREMENT NOT NULL, week_day VARCHAR(255) NOT NULL, lunch_start TIME NOT NULL, lunch_end TIME NOT NULL, lunch_max SMALLINT NOT NULL, dinner_start TIME NOT NULL, dinner_end TIME NOT NULL, dinner_max SMALLINT NOT NULL, day_num SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
